   ...
   <div class="admins">
        ...
        <form>
            <div class="form-group">
                ...
                <input type="text" placeholder="Enter first name"  v-model="user.firstName" class="form-control form-control-lg" />
            </div>

            <div class="form-group">
                <label>Last Name</label>
                <input type="text" placeholder="Enter last name"  v-model="user.lastName" class="form-control form-control-lg" />
            </div>
            ...
            <div class="form-group ">
                 <b-button variant="primary" @click.prevent="SignUp" class="btn  btn-lg btn-full "> Add </b-button>
            </div>
        </form>
